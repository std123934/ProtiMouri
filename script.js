...
function initMap() {
  ...
  map.attributionControl.setPrefix(
    'View <a href="http://github.com/jackdougherty/leaflet-storymap" target="_blank">code on GitHub</a>, created with <a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>'
  );
  ...
  ratingRef.orderByValue().once('value', function(data) {
    data.forEach(function(data) {
      ////////////////////////////////////////////////////////////////////////////
      var geojson = L.geoJson(data.val(), {
        onEachFeature: function(feature, layer) {
          (function(layer, properties) {
            ...
            areaBottom =
              areaTop + $('div#container' + feature.properties['id']).height();

            $('div#contents').scroll(function() {
              if (
                $(this).scrollTop() >= areaTop &&
                $(this).scrollTop() < areaBottom
              ) {
                $('.image-container')
                  .removeClass('inFocus')
                  .addClass('outFocus');
                $('div#container' + feature.properties['id'])
                  .addClass('inFocus')
                  .removeClass('outFocus');
      ...
      $('#contents').append(
        "<div class='space-at-the-bottom'><a href='#space-at-the-top'><i class='fa fa-chevron-up'></i></br><small>Top</small></a></div>"
      );
